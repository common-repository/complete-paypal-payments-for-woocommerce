(function ($) {
    'use strict';
    $(function () {
        $('#woocommerce_complete_paypal_payments_testmode').change(function () {
            var cpp_production_fields = $('#woocommerce_complete_paypal_payments_api_client_id, #woocommerce_complete_paypal_payments_api_secret').closest('tr');
            var cpp_sandbox_fields = $('#woocommerce_complete_paypal_payments_sandbox_client_id, #woocommerce_complete_paypal_payments_sandbox_api_secret').closest('tr');
            if ($(this).is(':checked')) {
                cpp_production_fields.hide();
                cpp_sandbox_fields.show();
                $('#woocommerce_complete_paypal_payments_live_api_details').hide();
                $('#woocommerce_complete_paypal_payments_sandbox_api_details').show();
            } else {
                cpp_sandbox_fields.hide();
                cpp_production_fields.show();
                $('#woocommerce_complete_paypal_payments_live_api_details').show();
                $('#woocommerce_complete_paypal_payments_sandbox_api_details').hide();
            }
        }).change();
        $('#woocommerce_complete_paypal_payments_enable_product_button').change(function () {
            if ($(this).is(':checked')) {
                $('.cpp_product_button_settings').closest('tr').show();
            } else {
                $('.cpp_product_button_settings').closest('tr').hide();
            }
        }).change();
        $('#woocommerce_complete_paypal_payments_enable_cart_button').change(function () {
            if ($(this).is(':checked')) {
                $('.cpp_cart_button_settings').closest('tr').show();
            } else {
                $('.cpp_cart_button_settings').closest('tr').hide();
            }
        }).change();
        $('#woocommerce_complete_paypal_payments_enable_checkout_button').change(function () {
            if ($(this).is(':checked')) {
                $('.cpp_checkout_button_settings').closest('tr').show();
            } else {
                $('.cpp_checkout_button_settings').closest('tr').hide();
            }
        }).change();
        $('#woocommerce_complete_paypal_payments_enable_mini_cart_button').change(function () {
            if ($(this).is(':checked')) {
                $('.cpp_mini_cart_button_settings').closest('tr').show();
            } else {
                $('.cpp_mini_cart_button_settings').closest('tr').hide();
            }
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_enable_advanced_card_payments').change(function () {
            if (jQuery(this).is(':checked')) {
                jQuery('#woocommerce_complete_paypal_payments_3d_secure_contingency').closest('tr').show();
            } else {
                jQuery('#woocommerce_complete_paypal_payments_3d_secure_contingency').closest('tr').hide();
            }
        }).change();
        var cpp_available = jQuery('#woocommerce_complete_paypal_payments_enable_advanced_card_payments, #woocommerce_complete_paypal_payments_3d_secure_contingency').closest('tr');
        if (cpp_param.is_advanced_cards_available === 'yes') {
            if (jQuery('#woocommerce_complete_paypal_payments_enable_advanced_card_payments').is(':checked')) {
                cpp_available.show();
            }
        } else {
            cpp_available.hide();
        ...
        var hide_show_home_shortcode = function () {
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_shortcode').change(function () {
                var home_preview_shortcode = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_preview_shortcode').closest('tr');
                if (jQuery(this).is(':checked')) {
        ...
        var hide_show_category_shortcode = function () {
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_shortcode').change(function () {
                var category_preview_shortcode = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_preview_shortcode').closest('tr');
                if (jQuery(this).is(':checked')) {
        ...
        var cpp_copy_text = function (css_class) {
        ...
        var hide_show_product_shortcode = function () {
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_shortcode').change(function () {
                var product_preview_shortcode = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_preview_shortcode').closest('tr');
                if (jQuery(this).is(':checked')) {
        ...
        var hide_show_cart_shortcode = function () {
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_shortcode').change(function () {
                var cart_preview_shortcode = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_preview_shortcode').closest('tr');
                if (jQuery(this).is(':checked')) {
        ...
        var hide_show_payment_shortcode = function () {
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_shortcode').change(function () {
                var payment_preview_shortcode = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_preview_shortcode').closest('tr');
                if (jQuery(this).is(':checked')) {
        ...
        setTimeout(function () {
            jQuery('#woocommerce_complete_paypal_payments_enabled_pay_later_messaging').trigger('change');

        }, 5000);
        cpp_copy_text('.home_copy_text');
        cpp_copy_text('.category_copy_text');
        cpp_copy_text('.product_copy_text');
        cpp_copy_text('.cart_copy_text');
        cpp_copy_text('.payment_copy_text');
        var is_pay_later_messaging_enable = function () {
            if (jQuery('#woocommerce_complete_paypal_payments_enabled_pay_later_messaging').is(':checked')) {
                return true;
            }
            return false;
        };
        var is_pay_later_messaging_home_page_enable = function () {
            ...
            if (jQuery.inArray('home', jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        var pay_later_messaging_home_page_hide_show = function () {
            ...
            var pay_later_messaging_home_preview = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_preview');
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_layout_type').trigger('change');
        ...
        var is_pay_later_messaging_category_page_enable = function () {
            ...
            if (jQuery.inArray('category', jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        var pay_later_messaging_category_page_hide_show = function () {
            ...
            var pay_later_messaging_category_preview = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_preview');
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_layout_type').trigger('change');
        ...
        var is_pay_later_messaging_product_page_enable = function () {
            ...
            if (jQuery.inArray('product', jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        var pay_later_messaging_product_page_hide_show = function () {
            ...
            var pay_later_messaging_product_preview = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_preview');
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_layout_type').trigger('change');
        ...
        var is_pay_later_messaging_cart_page_enable = function () {
            ...
            if (jQuery.inArray('cart', jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        var pay_later_messaging_cart_page_hide_show = function () {
            ...
            var pay_later_messaging_cart_preview = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_preview');
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_layout_type').trigger('change');
        ...
        var is_pay_later_messaging_payment_page_enable = function () {
            ...
            if (jQuery.inArray('payment', jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').val()) === -1) {
                return false;
            }
            return true;
        };
        var pay_later_messaging_payment_page_hide_show = function () {
            ...
            var pay_later_messaging_payment_preview = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_preview');
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_layout_type').trigger('change');
            hide_show_payment_shortcode();
        };
        jQuery('#woocommerce_complete_paypal_payments_enabled_pay_later_messaging').change(function () {
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').trigger('change');
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_page_type').change(function () {
        ...
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_layout_type').change(function () {
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_text_layout_logo_type').trigger('change');
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_text_layout_logo_type').change(function () {
            var pay_later_messaging_home_text_layout_logo_position = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_text_layout_logo_position').closest('tr');
            if (jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_home_layout_type').val() === 'text' && (this.value === 'primary' || this.value === 'alternative')) {
                if (is_pay_later_messaging_home_page_enable()) {
        ...
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_layout_type').change(function () {
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_text_layout_logo_type').trigger('change');
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_text_layout_logo_type').change(function () {
            var pay_later_messaging_category_text_layout_logo_position = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_text_layout_logo_position').closest('tr');
            if (jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_category_layout_type').val() === 'text' && (this.value === 'primary' || this.value === 'alternative')) {
                if (is_pay_later_messaging_category_page_enable()) {
        ...
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_layout_type').change(function () {
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_text_layout_logo_type').trigger('change');
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_text_layout_logo_type').change(function () {
            var pay_later_messaging_product_text_layout_logo_position = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_text_layout_logo_position').closest('tr');
            if (jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_product_layout_type').val() === 'text' && (this.value === 'primary' || this.value === 'alternative')) {
                if (is_pay_later_messaging_product_page_enable()) {
        ...
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_layout_type').change(function () {
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_text_layout_logo_type').trigger('change');
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_text_layout_logo_type').change(function () {
            var pay_later_messaging_cart_text_layout_logo_position = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_text_layout_logo_position').closest('tr');
            if (jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_cart_layout_type').val() === 'text' && (this.value === 'primary' || this.value === 'alternative')) {
                if (is_pay_later_messaging_cart_page_enable()) {
        ...
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_layout_type').change(function () {
            ...
            jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_text_layout_logo_type').trigger('change');
        }).change();
        jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_text_layout_logo_type').change(function () {
            var pay_later_messaging_payment_text_layout_logo_position = jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_text_layout_logo_position').closest('tr');
            if (jQuery('#woocommerce_complete_paypal_payments_pay_later_messaging_payment_layout_type').val() === 'text' && (this.value === 'primary' || this.value === 'alternative')) {
                if (is_pay_later_messaging_payment_page_enable()) {
        ...
        jQuery("#woocommerce_complete_paypal_payments_product_button_layout").change(function () {
            if ($('#woocommerce_complete_paypal_payments_enable_product_button').is(':checked')) {
                var complete_paypal_payments_product_tagline = jQuery("#woocommerce_complete_paypal_payments_product_button_tagline").closest('tr');
                if (this.value === 'vertical') {
                    complete_paypal_payments_product_tagline.hide();
                } else {
                    complete_paypal_payments_product_tagline.show();
                }
            }
        }).change();
        jQuery("#woocommerce_complete_paypal_payments_cart_button_layout").change(function () {
            if ($('#woocommerce_complete_paypal_payments_enable_cart_button').is(':checked')) {
                var complete_paypal_payments_cart_tagline = jQuery("#woocommerce_complete_paypal_payments_cart_button_tagline").closest('tr');
                if (this.value === 'vertical') {
                    complete_paypal_payments_cart_tagline.hide();
                } else {
                    complete_paypal_payments_cart_tagline.show();
                }
            }

        }).change();
        jQuery("#woocommerce_complete_paypal_payments_checkout_button_layout").change(function () {
            if ($('#woocommerce_complete_paypal_payments_enable_checkout_button').is(':checked')) {
                var complete_paypal_payments_checkout_tagline = jQuery("#woocommerce_complete_paypal_payments_checkout_button_tagline").closest('tr');
                if (this.value === 'vertical') {
                    complete_paypal_payments_checkout_tagline.hide();
                } else {
                    complete_paypal_payments_checkout_tagline.show();
                }
            }
        }).change();
        jQuery("#woocommerce_complete_paypal_payments_mini_cart_button_layout").change(function () {
            if ($('#woocommerce_complete_paypal_payments_enable_mini_cart_button').is(':checked')) {
                var complete_paypal_payments_mini_cart_tagline = jQuery("#woocommerce_complete_paypal_payments_mini_cart_button_tagline").closest('tr');
                if (this.value === 'vertical') {
                    complete_paypal_payments_mini_cart_tagline.hide();
                } else {
                    complete_paypal_payments_mini_cart_tagline.show();
                }
            }
        }).change();
    });
